        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <h2 className="font-serif text-4xl sm:text-5xl text-charcoal font-bold leading-tight mb-6">
              Wholesale <span className="gold-text-gradient">Inquiry</span>
            </h2>
            <div className="w-16 h-0.5 gold-gradient mb-8" />
            <p className="font-sans text-charcoal/70 text-base leading-relaxed mb-10">
              Are you a retailer, distributor, or jewellery shop owner looking
              for premium 1 gram and 2 gram gold jewellery at wholesale prices?
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="font-sans text-charcoal/65 text-sm leading-relaxed max-w-xs">
                  Thank you for reaching out to Shrigram. Our team will contact
                  you shortly with the best wholesale offers.
                </p>
                <button
                  type="button"
