...
const products = [
  {
    ...
    highlights: ['Lightweight & Comfortable', 'Perfect for Daily Wear', 'Ideal for Gifting', 'Wholesale Available'],
    badge: 'Bestseller',
  },
  {
    id: '2gram',
    ...
    highlights: ['Rich & Substantial', 'Occasion Wear', 'Wedding Collections', 'Bulk Orders Welcome'],
    badge: 'Premium',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-4xl sm:text-5xl text-charcoal font-bold mb-4">
            Crafted in{' '}
            <span className="gold-text-gradient">Pure Gold</span>
          </h2>
                ...
                <ul className="space-y-2 mb-6">
                  {product.highlights.map((h) => (
                    <li key={h} className="flex items-center gap-2.5">
                      ...
                      <span className="font-sans text-charcoal/70 text-sm">{h}</span>
                    </li>
                  ))}
                </ul>
