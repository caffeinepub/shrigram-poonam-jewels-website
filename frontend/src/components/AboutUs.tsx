        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="font-sans text-charcoal/75 text-base leading-relaxed mb-6">
              Nestled in the heart of Jamnagar, Gujarat — India's jewellery capital —
              <strong className="text-charcoal font-medium"> Poonam Jewels</strong> has
              been a trusted name in gold jewellery for discerning buyers across the
              region. Under our brand <strong className="text-charcoal font-medium">Shrigram</strong>,
              we bring you the finest 1 gram and 2 gram gold jewellery that combines
            ...
            <p className="font-sans text-charcoal/75 text-base leading-relaxed mb-10">
              Whether you are a retail customer seeking a perfect piece for a special
              occasion, or a wholesale buyer looking for premium quality at competitive
              prices, Shrigram is your trusted partner. Every piece we offer is a
              testament to our unwavering commitment to purity, beauty, and value.
            </p>
          ...
          <div className="relative">
            <div className="relative bg-charcoal rounded-none p-10 shadow-gold-lg">
              ...
              <div className="text-center mb-8">
                ...
                />
                <h3 className="font-serif text-gold text-2xl font-bold">Shrigram</h3>
